...
class Score(models.Model):
    ...
    exam = models.ForeignKey(Exam, on_delete=models.CASCADE, related_name='scores')  # Exam related to the score
    ...
    created_at = models.DateTimeField(auto_now_add=True)  # To track when the score was created
